...
class Login_controller extends BaseController{
    public function index(){
        ...
        $dato['titulo']= 'login';//en el ejemplo es $dato
    ...
    public function auth(){
        ...
        $data = $model->where('email',$email)->first();
            ...
            if($data){
                ...
                //se verifican los datos ingresasos para iniciar sesion, si cumple las condiciones para iniciar la sesion

                $verify_pass = password_verify($password, $pass);
                //password_verify determina los requisitos de configuacion de la contraseña
