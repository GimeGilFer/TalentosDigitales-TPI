...
use CodeIgniter\Controller; //en el video esta como "Controller"
...
class usuario_controller extends BaseController{
    ...
    public function create(){
        $dato['titulo']= 'registro';//en el ejemplo es $dato
    ...
    if (!$input){
        ...
        $formModel->save([
            //del lado izquierdo va el nombre del campo en la tabla y del lado derecho va como esta en el formulario
